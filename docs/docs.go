    ...
    "paths": {
        "/gateway/history": {
            "get": {
                ...
                "operationId": "gateway-history",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.gatewayResponse"
                        }
                    },
                    "500": {
        ...
        "/gateway/route": {
            "post": {
                ...
                "summary": "Route",
                "operationId": "do-route",
                "parameters": [
                    {
                        "description": "Set up gateway",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.doRouteRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/entity.Gateway"
                        }
                    },
                    "400": {
